...
using PyTrain.Web.Server.Authn;
using PyTrain.Web.Server.Authz;
using PyTrain.Web.Server.Data.Configuration;
...
using PyTrain.Web.Server.Services.LogonTokens;
using PyTrain.Web.Client.Services;
using PyTrain.Web.Server.Middleware;
using System.Security.Cryptography.X509Certificates;
using Microsoft.AspNetCore.Http.Features;
using PyTrain.Libraries.Hosting;
using PyTrain.Web.Server.Services.AgentInstaller;
using PyTrain.Web.Server.Services.DeviceManagement;

namespace PyTrain.Web.Server.Startup;

using PyTrain.Web.Server.Services.Settings;

public static class WebApplicationBuilderExtensions
{
  public static async Task<IHostApplicationBuilder> AddPyTrainServer(
    ...
    bool isOpenApiBuild)
  {
    ...
    {
      // Add telemetry.
      builder.AddServiceDefaults(ServiceNames.PyTrain, useServiceDiscovery: true);
    }
    else
    {
    ...
    builder.Services.AddSingleton<IPyTrainEmailSender>(sp => sp.GetRequiredService<EmailSender>());
