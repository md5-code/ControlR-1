...
namespace PyTrain.Web.Server.Data.Migrations
{
    ...
    [Migration("20251203184729_Installer_Key_Management")]
    partial class Installer_Key_Management
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.AgentInstallerKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.AgentInstallerKeyUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.PersonalAccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.ServerAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.TenantInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.TenantSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.UserPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AppUserTag", b =>
                {
                    b.HasOne("PyTrain.Web.Server.Data.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PyTrain.Web.Server.Data.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.AgentInstallerKey", b =>
                {
                    b.HasOne("PyTrain.Web.Server.Data.Entities.Tenant", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.AgentInstallerKeyUsage", b =>
                {
                    b.HasOne("PyTrain.Web.Server.Data.Entities.AgentInstallerKey", "AgentInstallerKey")
                        .WithMany("Usages")
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.Device", b =>
                {
                    ...
                    b.OwnsMany("PyTrain.Libraries.Shared.Models.Drive", "Drives", b1 =>
                        {
            ...
            modelBuilder.Entity("PyTrain.Web.Server.Data.Entities.PersonalAccessToken", b =>
                {
                    ...
                    b.HasOne("PyTrain.Web.Server.Data.Entities.AppUser", "User")
            ...
            modelBuilder.Entity("DeviceTag", b =>
                {
                    b.HasOne("PyTrain.Web.Server.Data.Entities.Device", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("PyTrain.Web.Server.Data.Entities.AppRole", null)
                        .WithMany()
