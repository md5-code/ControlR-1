...
namespace PyTrain.Web.Client.Components.Layout.DeviceAccess;
...
public partial class DeviceAccessLayout
{
  ...
  [Inject]
  public required ILazyInjector<IPyTrainApi> PyTrainApi { get; init; }
  [Inject]
  ...
  private async Task GetDeviceInfo()
  {
    ...
    try
    {
      var result = await PyTrainApi.Value.Devices.GetDevice(_deviceId);
