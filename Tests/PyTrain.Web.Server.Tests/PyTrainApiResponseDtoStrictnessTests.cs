...
public class PyTrainApiResponseDtoStrictnessTests(ITestOutputHelper testOutputHelper)
{
  ...
  private static PyTrainApi CreateClient(
    string jsonResponse,
    ...
    bool disableStreamingResponseDtoStrictness)
  {
    ...
    var options = new OptionsWrapper<PyTrainApiClientOptions>(new PyTrainApiClientOptions
    {
    ...
    return new PyTrainApi(httpClient, NullLogger<PyTrainApi>.Instance, options);
  }
