...
namespace PyTrain.Libraries.Ipc.Tests;
...
public class EndToEndTests(ITestOutputHelper testOutputHelper) : IAsyncLifetime
{
  ...
  public async Task ClientCanCallServerMethod()
  {
    ...
    serviceCollection.AddPyTrainIpcServer(_ => mockAgentService.Object);
    serviceCollection.AddPyTrainIpcClient(_ => mockClientService.Object);
