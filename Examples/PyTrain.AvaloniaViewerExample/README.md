# PyTrain Avalonia Viewer Example

This example demonstrates how to use the PyTrain Avalonia Viewer in a local dev environment.
...
```bash
cd Examples/PyTrain.AvaloniaViewerExample
...
### Injecting Options into PyTrainViewer

See [App.axaml.cs](./App.axaml.cs), [MainWindow.axaml](./Views/MainWindow.axaml), and [MainWindowViewModel.cs](./ViewModels/MainWindowViewModel.cs) for an example of how to realize the options and pass them into the `PyTrainViewer` control via data binding.
