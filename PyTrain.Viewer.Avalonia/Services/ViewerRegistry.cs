...
/// <summary>
/// Global registry for storing and retrieving PyTrainViewer instances and their associated service providers.
/// </summary>
public static class ViewerRegistry
{
  ...
  /// </summary>
  public static ViewerInstanceInfo Register(Guid instanceId, PyTrainViewer viewer, IServiceProvider serviceProvider)
  {
