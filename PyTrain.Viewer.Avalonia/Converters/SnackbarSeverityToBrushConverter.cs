...
namespace PyTrain.Viewer.Avalonia.Converters;
...
public class SnackbarSeverityToBrushConverter : IValueConverter
{
  ...
  public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
  {
    ...
    {
      var pytrainViewer = control.FindAncestorOfType<PyTrainViewer>();
      if (pytrainViewer?.TryFindResource(colorKey, pytrainViewer.ActualThemeVariant, out var color) == true
