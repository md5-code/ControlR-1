...
using PyTrain.Libraries.Messenger.Extensions.Messages;
...
{
  private readonly IPyTrainApi _apiClient;
  ...
  private readonly PyTrainViewerOptions _options;
  ...
  public ViewerShellViewModel(
    ...
    IOptions<PyTrainViewerOptions> options,
