...
namespace PyTrain.Agent.Startup;
...
internal static class CommandProvider
{
  internal static Command GetRunCommand(string[] args)
  {
    ...
    var runCommand = new Command("run", "Run the PyTrain service.")
    {
      instanceIdOption
    };
  ...
  internal static Command GetUninstallCommand(string[] args)
  {
    ...
    var unInstallCommand = new Command("uninstall", "Uninstall the PyTrain service.")
    {
      instanceIdOption
    };
    ...
    string? instanceId = null)
  {
    ...
    host.AddPyTrainAgent(startupMode, instanceId, serverUri: null);
    return host.Build();
  }
