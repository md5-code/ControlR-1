...
/// <summary>
/// Options for configuring the PyTrain API client.
/// </summary>
public class PyTrainApiClientOptions
{
  /// <summary>
  /// The name of the HTTP header used to send the personal access token (PAT) for authentication with the PyTrain API.
  /// </summary>
  public const string PersonalAccessTokenHeader = "x-personal-token";
  /// <summary>
  /// The default configuration section key for PyTrain API client options.
  /// </summary>
  public const string SectionKey = "PyTrainApiClient";

  /// <summary>
  /// The base URI where the PyTrain server is hosted (e.g. https://pytrain.example.com).
  /// </summary>
  ...
  /// A PAT is generated in the PyTrain UI and can be used to authenticate API requests.
  /// </summary>
