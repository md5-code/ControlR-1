...
public partial class PyTrainApi(
  ...
  ILogger<PyTrainApi> logger,
  IOptions<PyTrainApiClientOptions> options) :
  IPyTrainApi,
  IAgentUpdateApi,
  IAuthApi,
  IDesktopPreviewApi,
  ...
  IServerVersionApi
{
  ...
  private readonly ILogger<PyTrainApi> _logger = logger;
  private readonly IOptions<PyTrainApiClientOptions> _options = options;
