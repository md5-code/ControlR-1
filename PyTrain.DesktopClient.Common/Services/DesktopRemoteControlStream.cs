...
using PyTrain.DesktopClient.Common.Messages;
  ...
  private async Task SendDisplayData()
  {
    try
    {
      ...
      var displayDtos = displays.Select(x => new DisplayDto
      {
        ...
        LayoutCoordinateSpace = (PyTrain.Libraries.Api.Contracts.Enums.DisplayLayoutCoordinateSpace)x.LayoutCoordinateSpace,
