# PyTrain.Libraries.Signalr.Client

A strongly-typed SignalR client library that provides dynamic proxy generation for hub interfaces, simplifying client-server communication in PyTrain applications.
...
```csharp
using PyTrain.Libraries.Signalr.Client;
