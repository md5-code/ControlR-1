# PyTrain.Libraries.Avalonia

A cross-platform Avalonia UI library providing reusable controls, theming, and view model utilities for PyTrain desktop applications.
...
```xml
<ProjectReference Include="..\PyTrain.Libraries.Avalonia\PyTrain.Libraries.Avalonia.csproj" />
```
