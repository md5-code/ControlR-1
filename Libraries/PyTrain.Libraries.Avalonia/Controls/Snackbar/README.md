...
```csharp
services.AddPyTrainSnackbar(options =>
{
...
<Window xmlns="https://github.com/avaloniaui"
        ...
        xmlns:snackbar="using:PyTrain.Libraries.Avalonia.Controls.Snackbar"
        x:Class="PyTrain.DesktopClient.Views.MainWindow">
...
```csharp
using PyTrain.Libraries.Avalonia.Controls.Snackbar;
using PyTrain.Libraries.Shared.Enums;
