...
A comprehensive shared library providing common utilities, extensions, collections, primitives, and services used across all PyTrain applications.
...
```csharp
using PyTrain.Libraries.Shared.Collections;
...
- `PyTrain.Libraries.Shared.Collections` - Thread-safe collections
- `PyTrain.Libraries.Shared.Constants` - Application constants
- `PyTrain.Libraries.Shared.Converters` - JSON converters
- `PyTrain.Libraries.Shared.Extensions` - Extension methods
- `PyTrain.Libraries.Shared.Helpers` - Utility helpers
- `PyTrain.Libraries.Shared.IO` - I/O utilities
- `PyTrain.Libraries.Shared.Logging` - Logging utilities
- `PyTrain.Libraries.Shared.Primitives` - Primitive types and helpers
- `PyTrain.Libraries.Shared.Services` - Common services
