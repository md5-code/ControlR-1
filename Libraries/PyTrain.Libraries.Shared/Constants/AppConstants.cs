...
namespace PyTrain.Libraries.Shared.Constants;
...
public static class AppConstants
{
  ...
  public static string GetBundleZipDownloadPath(RuntimeId runtime)
  {
    ...
    {
      RuntimeId.WinX64 => "/downloads/win-x64/PyTrain.Agent.bundle.zip",
      RuntimeId.WinX86 => "/downloads/win-x86/PyTrain.Agent.bundle.zip",
      RuntimeId.LinuxX64 => "/downloads/linux-x64/PyTrain.Agent.bundle.zip",
      RuntimeId.MacOsX64 => "/downloads/osx-x64/PyTrain.Agent.bundle.zip",
      RuntimeId.MacOsArm64 => "/downloads/osx-arm64/PyTrain.Agent.bundle.zip",
      _ => throw new PlatformNotSupportedException()
    };
  }
  ...
  public static string GetInstallerDownloadPath(RuntimeId runtime)
  {
    return runtime switch
    {
      RuntimeId.WinX64 => "/downloads/win-x64/PyTrain.Agent.Installer.exe",
      RuntimeId.WinX86 => "/downloads/win-x86/PyTrain.Agent.Installer.exe",
      RuntimeId.LinuxX64 => "/downloads/linux-x64/PyTrain.Agent.Installer",
      RuntimeId.MacOsX64 => "/downloads/osx-x64/PyTrain.Agent.Installer",
      RuntimeId.MacOsArm64 => "/downloads/osx-arm64/PyTrain.Agent.Installer",
      _ => throw new PlatformNotSupportedException()
    };
  }
  ...
  public static string GetInstallerFileName(SystemPlatform platform)
  {
    return platform switch
    {
      SystemPlatform.Windows => "PyTrain.Agent.Installer.exe",
      SystemPlatform.Android => "PyTrain.Agent.Installer.exe",
      SystemPlatform.Linux => "PyTrain.Agent.Installer",
      SystemPlatform.MacOs => "PyTrain.Agent.Installer",
      _ => throw new PlatformNotSupportedException()
    };
  }
}
