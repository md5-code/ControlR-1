# PyTrain.Libraries.WebSocketRelay.Client

A client library for the WebSocket Relay service, providing managed relay stream connections for real-time data transfer in PyTrain remote control applications.
